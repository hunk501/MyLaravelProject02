...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">IR Edit</h1>                         
            </div>                
        </div><!-- /.col-lg-12 -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                {!! Form::open(['method'=>'PUT','url'=>'ir/'.$ir_id,'files'=>true]) !!}
                                <div class="form-group">
                                    <label>Agency.</label>
                                    <select name="agency" class="form-control">
                                        <option <?php echo ($record['agency'] == 'FPG') ? 'selected':''; ?> >FPG</option>
                                        <option <?php echo ($record['agency'] == 'Peoples') ? 'selected':''; ?> >Peoples</option>
                                        <option <?php echo ($record['agency'] == 'Standard') ? 'selected':''; ?> >Standard</option>                                        
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        @if($record['agency'] == 'Standard')
                                            <option  <?php echo ($record['type'] == 'Motor Car') ? 'selected':''; ?> >Motor Car</option>
                                            <option  <?php echo ($record['type'] == 'Motor') ? 'selected':''; ?> >Motor</option>
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nickname" class="form-control" value="{{ $record['nickname'] }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="year_make" class="form-control" value="{{ $record['year_make'] }}">                                            
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serial_no" class="form-control" value="{{ $record['serial_no'] }}">                                            
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="engine_no" class="form-control" value="{{ $record['engine_no'] }}">                                            
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inception_date" name="inception_date_from" class="datepicker form-control" placeholder="YYYY-MM-DD" value="{{ date('Y-m-d',strtotime($record['inception_date_from'])) }}" readonly="true" style="cursor: pointer;background-color: rgba(255, 255, 255, 0.15);">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inception_date_to" name="inception_date_to" class="datepicker form-control" placeholder="YYYY-MM-DD" value="{{ date('Y-m-d',strtotime($record['inception_date_to'])) }}" readonly="true" style="cursor: pointer;background-color: rgba(255, 255, 255, 0.15);">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="plate_no" class="form-control" value="{{ $record['plate_no'] }}">                                            
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="assured_value" class="number_only form-control" value="{{ $record['assured_value'] }}">                                            
