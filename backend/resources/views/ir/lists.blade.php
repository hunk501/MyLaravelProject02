...
<div id="wrapper">
    ...
    <div id="page-wrapper">		
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">IR Lists</h1>                    
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="{{ url('/ir/create') }}"><i class="fa fa-plus"></i> Add New</a>                            
                    </div>
                    <!-- /.panel-heading -->
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 9pt;">
                            ...
                            <tbody>
                                ...
                                <tr row-id="{{ $record->ir_id }}">											
                                    ...
                                    <td><a href="{{ url('/ir/'.$record->ir_id) }}"><i class="fa fa-folder-open"></i> View</a> &nbsp; 
                                        <a href="{{ url('/ir/'.$record->ir_id.'/edit') }}"><i class="fa fa-edit"></i> Edit</a></td>
                                </tr>
                                @endforeach
                                @endif	                                    	                                   
                            </tbody>
